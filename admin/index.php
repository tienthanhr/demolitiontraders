...
require_once 'auth-check.php'; // ✅ New: Centralized auth check

// Redirect if accessing from non-canonical path
                            ...
                            <table class="activity-table">
                                ...
                                <tbody>
                                    ${topOrders.map(order => {
                                        ...
                                        if (!customerName) customerName = order.guest_email || billing.email || 'Guest';
